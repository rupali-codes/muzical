            ...
            <nav className="bg-muzical_secondary_low border-muzical_secondary_low h-[80px]  ">
                <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto py-4">
                    <a href={`${process.env.NEXT_PUBLIC_API_ROOT}`} className="flex items-center">
                        <img src={`${process.env.NEXT_PUBLIC_API_ROOT}/images/logo.png`} className="h-14" alt="Muzical Logo" />
                    </a>
                    ...
                    <div className="hidden w-full md:block md:w-auto relative z-10" id="navbar-default">
                        <ul className="font-medium flex flex-col p-4 md:p-0 mt-4  rounded-lg bg-muzical_secondary_low md:flex-row md:space-x-5 md:mt-0 md:border-0 ">
                            <li>
